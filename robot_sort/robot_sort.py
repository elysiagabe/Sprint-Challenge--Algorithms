    ...
    def sort(self):
        ...
        while self.light_is_on():
            ...
            while self.can_move_right() == True: 
                # if compare_item() == -1 (held item is less than item at position) OR if == None: 
            ...
            while self.can_move_left(): 
                ...
                if self.compare_item() == None and self.can_move_right(): 
                    # swap & switch direction (move right)
                    self.swap_item()
                    self.move_right()
                # compare_item() == 1 (held item is greater than item at position)
